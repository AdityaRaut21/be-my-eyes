        ...
        textToSpeech = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if (status != TextToSpeech.ERROR) {
                    ...
                    if (firstTime == 0)
                        textToSpeech.speak("Welcome to your vision. Swipe left to listen the features of the app and swipe right and say what you want", TextToSpeech.QUEUE_FLUSH, null);
                }
            }
        });
        ...
        if (requestCode == REQ_CODE_SPEECH_INPUT) {
            if (resultCode == RESULT_OK && null != data) {
                ...
                if (mVoiceInputTv.getText().toString().equals("yes")) {
                    textToSpeech.speak("  Say Read for reading,  calculator for calculator,  time and date,  weather for weather,  battery for battery, call for call, message for messag. Do you want to listen again", TextToSpeech.QUEUE_FLUSH, null);
                    mVoiceInputTv.setText(null);
                ...
                if(mVoiceInputTv.getText().toString().equals("Call")) {
                    Intent intentCall = new Intent(getApplicationContext(), MainActivity9.class);
